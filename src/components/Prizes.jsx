    ...
    return (
        <div className="flex flex-col items-center justify-center mb-5 md:mb-25">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3  m-10 gap-8">
                    <div className="order-2 md:order-1 lg:order-1 col-span-1 md:col-span-3 bg-black p-10 w-[300px] md:w-[400px] animate-pulse rounded-lg shadow-lg shadow-[#E5E5E5] ">
                    ...
                    <div className="order-1 md:order-2 lg:order-2 col-span-1 md:col-span-3 bg-black p-10 animate-pulse rounded-lg shadow-lg shadow-[#FFD700]">
                    ...
                    <div className="order-3 md:order-3 lg:order-3 col-span-1 md:col-span-3 bg-black p-10 animate-pulse rounded-lg shadow-lg shadow-[#E5E5E5]">
